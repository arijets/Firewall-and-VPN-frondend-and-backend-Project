...
<div class="doctors-posts doctors-page clearfix">
    <div class="container">
        <div class="row">
            ...
            <div class="<?php bc_all('12'); ?>">
                <ul id="filters">
                    <li class="active"><a href="#" data-filter="*"><?php esc_html_e('All Departments', 'framework') ?></a></li>
                    <?php
                    global $post;
                    $args = array(
                        'orderby' => 'name',
                    ...
                    if (!empty($tax_terms)) {
                        foreach ($tax_terms as $term) {
                            echo '<li><a href="' . get_term_link( $term->slug, $term->taxonomy ) . '" data-filter=".' . esc_attr( $term->slug ) . '">' . esc_html( $term->name ) . '</a></li>';
                        }
                    }
                    ?>
                </ul>
        ...
        <div id="isotope-container" class="isotope-wrapper row text-center">
            ...
            if ($doctor_query->have_posts()) {
                ...
                while ($doctor_query->have_posts()) {
                    ...
                    ?>
                    <div class="isotope-item <?php echo esc_attr( $doc_terms_slugs ); ?> <?php echo esc_attr( $bootstrap_classes ); ?>">
