...
<div class="gallery-page clearfix">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="<?php bc_all('12'); ?>">
                <ul id="filters">
                    <li class="active"><a href="#" data-filter="*"><?php esc_html_e('All', 'framework'); ?></a></li>
                    <?php
                    global $post;
                    $args = array(
                        'orderby' => 'name',
        ...
        <div id="isotope-container" class="isotope-wrapper row text-center">
            ...
            if ($gallery_query->have_posts()) {
                ...
                while ($gallery_query->have_posts()) {
                    ...
                    ?>
                    <div class="isotope-item <?php echo esc_attr( $gallery_terms_slugs ); ?> <?php echo esc_attr( $bootstrap_classes ); ?>">
                        <article class="common clearfix hentry <?php if (is_page_template('templates/gallery-four-col.php')) {
                                echo esc_attr( 'four-col-gallery' );
                            } ?>">
                            <?php
                ...
                nothing_found( esc_html__('No gallery item found!', 'framework'));
            }
