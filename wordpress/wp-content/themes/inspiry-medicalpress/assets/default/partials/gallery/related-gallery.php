                        ...
                        <div class="clearfix">
                            <div id="related-gallery-items-title" class="slogan-section text-left clearfix">
                                ...
                                if ( !empty( $theme_options['related_gallery_items_title'] ) ) {
                                    echo '<h2>' . wp_kses( $theme_options['related_gallery_items_title'], $allowed_html_tags ) . '</h2>';
                                }
                                if ( !empty( $theme_options['related_gallery_items_description'] ) ) {
                                    echo '<p>' . wp_kses( $theme_options['related_gallery_items_description'], $allowed_html_tags ) . '</p>';
                                }
                                ?>
                            </div>
                        </div>
