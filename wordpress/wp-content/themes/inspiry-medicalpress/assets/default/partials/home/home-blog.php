...
?>
<div class="home-blog <?php echo esc_attr( $home_blog ); ?> clearfix">
    <div class="container">
        <div class="row">
                ...
                if (!empty($theme_options['home_news_title']) || !empty($theme_options['home_news_description'])) {
                    ...
                    <div class="slogan-section animated fadeInUp clearfix">
                        ...
                        if (!empty($theme_options['home_news_title'])) {
                            echo '<h2>' . wp_kses( $theme_options['home_news_title'], $allowed_html_tags ) . '</h2>';
                        }
                        if (!empty($theme_options['home_news_description'])) {
                            echo '<p>' . wp_kses( $theme_options['home_news_description'], $allowed_html_tags ) . '</p>';
                        }
                        ?>
                    </div>
                    <?php
