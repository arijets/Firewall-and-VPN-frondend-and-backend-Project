...
?>
<div class="home-doctors <?php echo esc_attr( $default_class ); ?> clearfix">
    ...
    <div class="container">
                ...
                <div class="<?php bc_all('12'); ?> ">
                    <div class="slogan-section animated fadeInUp clearfix">
                        ...
                        if (!empty($theme_options['home_doctors_title'])) {
                            echo '<h2>' . wp_kses( $theme_options['home_doctors_title'], $allowed_html_tags ) . '</h2>';
                        }
                        if (!empty($theme_options['home_doctors_description'])) {
                            echo '<p>' . wp_kses( $theme_options['home_doctors_description'], $allowed_html_tags ) . '</p>';
                        }
                        ?>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            if ($team_query->have_posts()) {
                    ...
                    <div class="<?php
                        ...
                        <div class="common-doctor animated fadeInUp clearfix">
                            ...
                            <div class="text-content">
                                ...
                                if ( !empty($intro_text) ) {
                                    echo wp_kses( $intro_text, $allowed_html_tags );
                                }
                                ?>
                                </p>
                            </div>
                ...
                nothing_found( esc_html__('No Doctors found !', 'framework') );
            }
