...
?>
<div class="home-testimonial <?php echo esc_attr( $testimonial_var ); ?> clearfix">
    <div class="container">
        <div class="row">
            <?php
                ...
                <div class="<?php bc_all('12'); ?> text-center">
                    <div class="slogan-section animated fadeInUp clearfix">
                        ...
                        if ( !empty( $theme_options['home_testimonials_title'] ) ) {
                            echo '<h2>' . wp_kses( $theme_options['home_testimonials_title'], $allowed_html_tags ) . '</h2>';
                        }
                        if (!empty($theme_options['home_testimonials_description'])) {
                            echo '<p>' . wp_kses( $theme_options['home_testimonials_description'], $allowed_html_tags ) . '</p>';
                        }
                        ?>
                    </div>
                </div>
                                ...
                                <li>
                                    ...
                                    <div class="testimonial-footer clearfix">
                                        ...
                                        if ( !empty($testimonial_author_link) && !empty($testimonial_author_organization) ) {
                                            ?>
                                            <p><a target="_blank" href="<?php echo esc_url( $testimonial_author_link ); ?>"><?php echo esc_html( $testimonial_author_organization ); ?></a></p>
                                            <?php
                                        }
                                        ?>
                                    </div>
