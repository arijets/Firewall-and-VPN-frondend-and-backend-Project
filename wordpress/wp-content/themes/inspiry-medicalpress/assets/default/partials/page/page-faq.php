            ...
            <div class="<?php bc('9', '8', '12', ''); ?>">
                <div class="row">
                    ...
                    <div class="<?php bc_all('12'); ?>">
                        <ul id="filters">
                            <li class="active"><a class="no-isotope" href="#" data-filter="*"><?php esc_html_e('All FAQs', 'framework') ?></a></li>
                            <?php
                            $args = array(
                                'orderby' => 'name',
                                'order' => 'ASC',
                            ...
                            if (!empty($tax_terms)) {
                                foreach ($tax_terms as $term) {
                                    echo '<li><a class="no-isotope" href="' . get_term_link( $term->slug, $term->taxonomy ) . '" data-filter=".' . esc_attr( $term->slug ) . '">' . esc_html( $term->name ) . '</a></li>';
                                }
                            }
                            ?>
                        </ul>
                    ...
                    <div class="<?php bc_all('12'); ?>">
                        ...
                        if ($faq_query->have_posts()) {
                            ...
                            while ($faq_query->have_posts()) {
                                ...
                                ?>
                                <div class="toggle <?php echo esc_attr( $faq_group_terms_slugs ); ?>">
                            ...
                            nothing_found( esc_html__('No FAQ found!', 'framework') );
                        }
