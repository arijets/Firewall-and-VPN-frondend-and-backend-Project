...
<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> >
    ...
    <div class="left_meta clearfix entry-meta">
        ...
        <span class="comments_count clearfix entry-comments-link"><?php comments_popup_link( esc_html__('0', 'framework'), esc_html__('1', 'framework'), esc_html__('%', 'framework') ); ?></span>
    </div>
    ...
    <div class="right-contents">
        ...
        if ( ($format !== 'quote') && ($format !== 'link') ) {
            ?><a class="read-more" href="<?php the_permalink(); ?>" rel="bookmark"><?php esc_html_e('Read More', 'framework'); ?></a><?php
        }
        ?>
    </div>
</article>