                    ...
                    if ( ( ! empty( $theme_options['related_doctors_title'] ) ) || ( ! empty( $theme_options['related_doctors_description'] ) ) ) : ?>
                        <header class="home-section-header">
                            ...
                            if ( ! empty( $theme_options['related_doctors_title'] ) ) :
                                echo '<h2 class="home-section-title">' . esc_html( $theme_options['related_doctors_title'] ) . '</h2>';
                            endif;

                            if ( ! empty( $theme_options['related_doctors_description'] ) ) :
                                echo '<p class="home-section-description">' . wp_kses( $theme_options['related_doctors_description'], $allowed_html_tags ) . '</p>';
                            endif;
                            ?>
                        </header>
                    <?php endif; ?>
