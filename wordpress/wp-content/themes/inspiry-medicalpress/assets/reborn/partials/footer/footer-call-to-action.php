                ...
                foreach ( $contact_methods as $contact_method ) :
                    ...
                    if ( ! empty( $contact_method_title ) || ! empty( $contact_method_content ) ) : ?>
                        <div class="<?php echo esc_attr( $col_class ); ?>">
                            <div class="call-to-action-item call-to-action-contact-<?php echo intval( $count ); ?>">
                                <?php
                                if ( ! empty( $contact_method_image ) ) : ?>
                                    <div class="call-to-action-icon">
                                        <img src="<?php echo esc_url( $contact_method_image ); ?>" alt="<?php echo esc_html( $contact_method_title ); ?>">
                                    </div>
                                <?php endif; ?>
