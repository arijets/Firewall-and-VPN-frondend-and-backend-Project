<?php
global $post, $theme_options, $allowed_html_tags;
                ...
                if ( ( ! empty( $theme_options['related_doctors_title'] ) ) || ( ! empty( $theme_options['related_doctors_description'] ) ) ) : ?>
                    <header class="home-section-header">
                        ...
                        if ( ! empty( $theme_options['related_gallery_items_title'] ) ) :
                            echo '<h2 class="home-section-title">' . wp_kses( $theme_options['related_gallery_items_title'], $allowed_html_tags ) . '</h2>';
                        endif;

                        if ( ! empty( $theme_options['related_gallery_items_description'] ) ) :
                            echo '<p class="home-section-description">' . wp_kses( $theme_options['related_gallery_items_description'], $allowed_html_tags ) . '</p>';
                        endif;
                        ?>
                    </header>
                <?php endif; ?>
