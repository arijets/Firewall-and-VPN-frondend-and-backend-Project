...
if ( isset( $theme_options['header_contact_number'] ) && ! empty( $theme_options['header_contact_number'] ) ) :
    ...
    <div class="header-contact-number">
        ...
        <a class="mobile-version" href="tel://<?php echo esc_attr( preg_replace( "/[^0-9]/", "", $header_contact_number ) ); ?>" title="<?php esc_html_e( 'Make a Call', 'framework' ); ?>"><?php echo esc_html( $header_contact_number ); ?></a>
