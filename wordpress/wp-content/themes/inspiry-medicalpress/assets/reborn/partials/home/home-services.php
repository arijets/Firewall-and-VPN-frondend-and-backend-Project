<div class="home-section home-services">
    <div class="container">
		...
		if ( ( ! empty( $theme_options['home_services_title'] ) ) || ( ! empty( $theme_options['home_services_description'] ) ) ) :
            ...
            <header class="home-section-header animated fadeInUp">
				...
				if ( ! empty( $theme_options['home_services_title'] ) ) :
					echo '<h2 class="home-section-title">' . wp_kses( $theme_options['home_services_title'], $allowed_html_tags ) . '</h2>';
				endif;

				if ( ! empty( $theme_options['home_services_description'] ) ) :
					echo '<p class="home-section-description">' . wp_kses( $theme_options['home_services_description'], $allowed_html_tags ) . '</p>';
				endif;
				?>
            </header>
			<?php
		...
		if ( $services_query->have_posts() ) : ?>
			...
			nothing_found( esc_html__( 'No Service found !', 'framework' ) );
		endif;
