                    ...
                    <div class="col-md-5 col-lg-6">
                        <div class="contact-sidebar">
                            <?php if ( ! empty( $theme_options['contact_details_title'] ) ) : ?>
                                <h2><span><?php echo esc_html( $theme_options['contact_details_title'] ); ?></span></h2>
                            <?php endif; ?>
                            ...
                            <?php if ( ! empty( $theme_options['contact_phone'] ) ) : ?>
                                <p><strong><?php esc_html_e( 'Phone:', 'framework' ); ?></strong> <?php echo esc_html( $theme_options['contact_phone'] ); ?></p>
                            <?php endif; ?>

                            <?php if ( ! empty( $theme_options['contact_fax'] ) ) : ?>
                                <p><strong><?php esc_html_e( 'Fax:', 'framework' ); ?></strong> <?php echo esc_html( $theme_options['contact_fax'] ); ?></p>
                            <?php endif; ?>
