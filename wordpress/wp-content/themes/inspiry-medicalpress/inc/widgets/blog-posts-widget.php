	...
	class Inspiry_Posts_Widget extends WP_Widget {
		...
		function __construct() {
			$widget_ops = array(
				...
				'description' => esc_html__( 'Displays popular or recent blog posts.', 'framework' )
			);
			parent::__construct( 'Inspiry_Posts_Widget', esc_html__( 'MedicalPress - Blog Posts', 'framework' ), $widget_ops );
		}

		function widget( $args, $instance ) {

			$title = ( ! empty( $instance['title'] ) ? $instance['title'] : esc_html__( 'Popular Blog Posts', 'framework' ) );
