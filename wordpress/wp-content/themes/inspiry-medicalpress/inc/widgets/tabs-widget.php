...
if (!class_exists('Tabs_Widget')) {
    class Tabs_Widget extends WP_Widget
    {
        ...
        function __construct() {
            $widget_ops = array( 'classname' => 'tabs-widget', 'description' => esc_html__( 'This widget displays popular posts, recent posts and recent comments.', 'framework' ) );
            parent::__construct( 'Tabs_Widget', esc_html__( 'MedicalPress - Tabs', 'framework'), $widget_ops );
        }
        ...
        function form($instance)
        {
            $instance = wp_parse_args((array)$instance, array(
                    'tab_title_one' => esc_html__('Popular', 'framework'),
                    'tab_title_two' => esc_html__('Latest', 'framework'),
                    'tab_title_three' => esc_html__('Comments', 'framework'),
            ...
            ?>
            <p>
                <label for="<?php echo $this->get_field_id('tab_title_one'); ?>"><?php esc_html_e('First Tab Title', 'framework'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('tab_title_two'); ?>"><?php esc_html_e('Second Tab Title', 'framework'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('tab_title_three'); ?>"><?php esc_html_e('Third Tab Title', 'framework'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('theme_tab_one'); ?>"><?php esc_html_e('First Tab Content', 'framework'); ?></label>
                <select name="<?php echo $this->get_field_name('theme_tab_one'); ?>" id="<?php echo $this->get_field_id('theme_tab_one'); ?>">
                    <option value="popular_posts"<?php selected($theme_tab_one, 'popular_posts'); ?>><?php esc_html_e('Popular Posts', 'framework'); ?></option>
                    <option value="recent_posts"<?php selected($theme_tab_one, 'recent_posts'); ?>><?php esc_html_e('Recent Posts', 'framework'); ?></option>
                    <option value="comments"<?php selected($theme_tab_one, 'comments'); ?>><?php esc_html_e('Comments', 'framework'); ?></option>
                </select>
            </p>
            <p>
                <label for="<?php echo $this->get_field_id('theme_tab_two'); ?>"><?php esc_html_e('Second Tab Content', 'framework'); ?></label>
                <select name="<?php echo $this->get_field_name('theme_tab_two'); ?>" id="<?php echo $this->get_field_id('theme_tab_two'); ?>">
                    <option value="popular_posts"<?php selected($theme_tab_two, 'popular_posts'); ?>><?php esc_html_e('Popular Posts', 'framework'); ?></option>
                    <option value="recent_posts"<?php selected($theme_tab_two, 'recent_posts'); ?>><?php esc_html_e('Recent Posts', 'framework'); ?></option>
                    <option value="comments"<?php selected($theme_tab_two, 'comments'); ?>><?php esc_html_e('Comments', 'framework'); ?></option>
                </select>
            </p>
            <p>
                <label for="<?php echo $this->get_field_id('theme_tab_three'); ?>"><?php esc_html_e('Third Tab Content', 'framework'); ?></label>
                <select name="<?php echo $this->get_field_name('theme_tab_three'); ?>" id="<?php echo $this->get_field_id('theme_tab_three'); ?>">
                    <option value="popular_posts"<?php selected($theme_tab_three, 'popular_posts'); ?>><?php esc_html_e('Popular Posts', 'framework'); ?></option>
                    <option value="recent_posts"<?php selected($theme_tab_three, 'recent_posts'); ?>><?php esc_html_e('Recent Posts', 'framework'); ?></option>
                    <option value="comments"<?php selected($theme_tab_three, 'comments'); ?>><?php esc_html_e('Comments', 'framework'); ?></option>
                </select>
            </p>
            <p>
                <label for="<?php echo $this->get_field_id('number'); ?>"><?php esc_html_e('Number of items to show:', 'framework'); ?></label>
